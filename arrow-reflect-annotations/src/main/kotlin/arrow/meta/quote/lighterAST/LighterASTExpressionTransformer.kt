...
class LighterASTExpressionTransformer(
  session: FirSession,
  tree: FlyweightCapableTreeStructure<LighterASTNode>,
  private val declarationBuilder: LighterASTDeclarationTransformer,
  ...
  inline fun <reified R : FirExpression> wrapExpressionIfNeeded(
    expression: LighterASTNode?,
