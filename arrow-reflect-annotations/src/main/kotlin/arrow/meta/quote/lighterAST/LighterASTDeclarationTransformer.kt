package arrow.meta.module.impl.arrow.meta.quotes.lighterAST
...
import org.jetbrains.kotlin.fir.lightTree.converter.AbstractLightTreeRawFirBuilder
import org.jetbrains.kotlin.fir.lightTree.converter.extractArgumentsFrom
import org.jetbrains.kotlin.fir.lightTree.converter.getAsStringWithoutBacktick
import org.jetbrains.kotlin.fir.lightTree.converter.isClassLocal
...
class LighterASTDeclarationTransformer(
  session: FirSession,
  ...
  private val expressionConverter = LighterASTExpressionTransformer(session, tree, this, context)

  fun getDeclarationsFrom(node: LighterASTNode): List<FirDeclaration> {
      ...
      contextList?.forEachChildren {
        when (it.elementType) {
          CONTEXT_RECEIVER, VALUE_PARAMETER -> {
            ...
            contextParameterTypeRefs += typeReference?.let(this@LighterASTDeclarationTransformer::convertType)
